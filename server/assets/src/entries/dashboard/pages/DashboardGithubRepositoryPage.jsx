...
const DashboardGithubRepositoryPage = function ({
  currentUser,
  match,
  router,
  path,
...
export const DashboardGithubRepositoryPageQuery = graphql`
  query DashboardGithubRepositoryPage_Query($githubRepositoryId: ID!) {
    currentUser {
...
export default DashboardGithubRepositoryPage;
