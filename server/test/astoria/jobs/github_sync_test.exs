defmodule Astoria.Jobs.GithubSyncTest do
  alias Astoria.{Jobs.GithubSync, Repo, GithubInstallations, Github}
  ...
  describe "update_github_installation_rate_limits/2" do
    test "with values present" do
      ...
      assert {:ok, github_installation} =
               GithubSync.update_github_installation_rate_limits(github_installation, response)
