...
const GithubRepositoryPlotsAnalysisChangedLinesLoader = function ({
  githubRepositoryId,
}) {
  const renderQuery = ({ error, props }) => {
    if (error) {
      ...
      return (
        <PlotHero
          plotHero={props.currentUser.githubRepository.analysisChangedLines}
        />
      );
    }
...
export default GithubRepositoryPlotsAnalysisChangedLinesLoader;
